<template>
	<div class="review-frame">
		<div class="review-item" v-for="(item,key) in items" :key="key">
			<div class="user-info row-start-center">				
				<VanImage :src="item.user.avatar" width="50" height="50" fit="cover" round/>
				<div class="user-name"><b>{{ item.user.name }}</b></div>
			</div>
				...
				<div class="review-info-frame" @click.stop>
					<div class="order-text">
						...
						<div class="reply-item">
							<Field v-model="reply.text" rows="4" autosize type="textarea" placeholder="请输入回复内容" maxlength="150" show-word-limit/>
						</div>
					</div>
					<div class="review-action row-start-center">
